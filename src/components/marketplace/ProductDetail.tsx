    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 md:p-8">
        ...
        <motion.div
          ...
          className="relative w-full max-w-6xl h-full max-h-[90vh] glass border border-primary/20 rounded-[2.5rem] overflow-hidden shadow-[0_0_100px_rgba(99,102,241,0.1)] flex flex-col md:flex-row"
        >
          {/* Close Button */}
          <button
            onClick={onClose}
            className="absolute top-6 right-6 z-20 p-3 rounded-full glass border border-border/50 hover:bg-white/10 transition-colors"
          >
            <X className="w-6 h-6" />
          </button>
          ...
          <div className="md:w-1/2 relative h-64 md:h-auto">
            ...
            <div className="absolute bottom-8 left-8 space-y-4">
              ...
              <h1 className="font-display text-4xl md:text-5xl font-bold text-white glow-text">
                {product.title}
              </h1>
            </div>
          </div>
          ...
          <div className="md:w-1/2 overflow-y-auto p-8 md:p-12">
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="flex gap-2">
                <button className="p-3 rounded-xl glass border border-border/50 hover:bg-primary/10 transition-colors">
            ...
            <div className="flex items-center gap-6 pt-8 border-t border-border/50">
              ...
              <div className="flex-1 flex gap-3">
                <button className="flex-1 py-4 rounded-2xl glass border border-primary/30 font-bold hover:bg-primary/10 transition-all flex items-center justify-center gap-2">
                  <ShoppingCart className="w-5 h-5" />
                  Add to Cart
                </button>
                <button className="flex-1 py-4 rounded-2xl bg-gradient-to-r from-primary to-secondary text-white font-bold shadow-lg shadow-primary/20 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2">
